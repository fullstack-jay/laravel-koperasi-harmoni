...
enum POStatusEnum: string
{
    ...
    case MENUNGGU_PERSETUJUAN_SUPPLIER = 'menunggu_persetujuan_supplier';
    ...
    public function getLabel(): string
    {
        return match ($this) {
            ...
            self::MENUNGGU_PERSETUJUAN_SUPPLIER => 'Menunggu Persetujuan Supplier',
    ...
    {
        return match ($this) {
            self::DRAFT => in_array($status, [self::MENUNGGU_PERSETUJUAN_SUPPLIER, self::DIBATALKAN_DRAFT]),
            self::DIBATALKAN_DRAFT => in_array($status, [self::MENUNGGU_PERSETUJUAN_SUPPLIER]), // Cancelled draft can be re-sent
            self::MENUNGGU_PERSETUJUAN_SUPPLIER => in_array($status, [self::PERUBAHAN_HARGA, self::DIKONFIRMASI_SUPPLIER, self::DIBATALKAN_DRAFT]),
            self::PERUBAHAN_HARGA => in_array($status, [self::MENUNGGU_PERSETUJUAN_SUPPLIER, self::DIKONFIRMASI_SUPPLIER, self::DIBATALKAN_KOPERASI]),
